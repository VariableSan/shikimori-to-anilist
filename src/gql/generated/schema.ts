...
/**
 * __useSetAnimeToUserListMutation__
 *
 * To run a mutation, you first call `useSetAnimeToUserListMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useSetAnimeToUserListMutation` returns an object that includes:
 ...
 *
 * @example
 * const { mutate, loading, error, onDone } = useSetAnimeToUserListMutation({
 *   variables: {
 ...
 * });
 */
export function useSetAnimeToUserListMutation(options: VueApolloComposable.UseMutationOptions<SetAnimeToUserListMutation, SetAnimeToUserListMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<SetAnimeToUserListMutation, SetAnimeToUserListMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<SetAnimeToUserListMutation, SetAnimeToUserListMutationVariables>(SetAnimeToUserListDocument, options);
}
export type SetAnimeToUserListMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<SetAnimeToUserListMutation, SetAnimeToUserListMutationVariables>;
 ...
 *
 * To run a query within a Vue component, call `useGetAnimeListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAnimeListQuery` returns an object from Apollo Client that contains result, loading and error properties
 ...
 *
 * @example
 * const { result, loading, error } = useGetAnimeListQuery({
 *   userName: // value for 'userName'
 * });
 */
export function useGetAnimeListQuery(variables: GetAnimeListQueryVariables | VueCompositionApi.Ref<GetAnimeListQueryVariables> | ReactiveFunction<GetAnimeListQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<GetAnimeListQuery, GetAnimeListQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetAnimeListQuery, GetAnimeListQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetAnimeListQuery, GetAnimeListQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetAnimeListQuery, GetAnimeListQueryVariables>(GetAnimeListDocument, variables, options);
}
export function useGetAnimeListLazyQuery(variables: GetAnimeListQueryVariables | VueCompositionApi.Ref<GetAnimeListQueryVariables> | ReactiveFunction<GetAnimeListQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<GetAnimeListQuery, GetAnimeListQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetAnimeListQuery, GetAnimeListQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetAnimeListQuery, GetAnimeListQueryVariables>> = {}) {
