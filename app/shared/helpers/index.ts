import { MediaListStatus } from '~/models/anilist.model'
import type { UserRate } from '~/models/shikimori.model'
import { AnimeStatus as ShikiAnimeStatus } from '~/models/shikimori.model'

export const defaultTimeoutSec = 60

export function convertShikiStatusToAnilist(skikiAnimeStatus: ShikiAnimeStatus) {
